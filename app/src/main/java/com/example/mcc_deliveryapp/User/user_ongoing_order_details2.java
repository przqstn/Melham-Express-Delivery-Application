...
public class user_ongoing_order_details2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_user_ongoing_order_details2);
        ...
        btn_trackCourier.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(user_ongoing_order_details2.this, user_track_rider2.class);
    ...
    {
        Intent intent = new Intent(user_ongoing_order_details2.this, MainActivity2.class);
        intent.setFlags(Intent.FLAG_ACTIVITY_NEW_TASK | Intent.FLAG_ACTIVITY_CLEAR_TASK);
        startActivity(intent);
    }
