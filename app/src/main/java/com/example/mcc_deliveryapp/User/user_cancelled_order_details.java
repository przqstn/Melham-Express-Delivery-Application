...
public class user_cancelled_order_details extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_user_cancelled_order_details);
...
//                        riderName = dataSnapshot.child("ridername").getValue(String.class);
    ...
    {
        Intent intent = new Intent(user_cancelled_order_details.this, user_navigation.class);
